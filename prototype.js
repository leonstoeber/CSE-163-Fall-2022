...
d3.text("data.csv", function(error, painter) {
    ...
    var colNames = "painter,size,group,color,painting,link,c0,c1,c2,c3,c4,c5,c6,c7\n" + painter;
    ...
    console.table(data, ["painter", "size", "group", "color", "painting", "link", "c0", "c1", "c2", "c3", "c4", "c5", "c6", "c7"]);
